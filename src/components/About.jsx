      ...
      <div className="about-section">
        <div className="about-box">
          ...
          <ul>
            ...
            <li>Collaboration: We believe in the power of collaboration and teamwork, recognizing that by working together, we can achieve far greater impact than by acting alone.</li>
